    ...
    <section>
      <form class="row g-3" id="comment-form" action="/comments/new" method="post"><input type="hidden" name="_csrf" value="b6f4188d-b33d-4ef7-ae88-065721302f3a"/>
        ...
        <div class="col-md-9 col-lg-8">
          ...
          <textarea class="form-control" id="comment-textbox" placeholder="댓글 쓰기.." rows="3" required name="content" onChange={handleCommentChange}></textarea>
        </div>
